...
public class AnalysisTest extends BaseTest{
	...
	//	@Test(priority = 15, description = "Verify Graph with All Eight types of PLot creation")
	//	public void AllEightTypesOfPlotCreation_Test() throws Throwable {
	//		try {
	//
	//			String functionName = new Object(){}.getClass().getEnclosingMethod().getName();
	//
	...
	//
	//			/* Select a Numerical value in Analysis and Verify the summary statistics headers */	
	//			objAnalysisPage.AllEightTypesOfPlotCreation(AnalysisName,AnalysisDescription,StudyIndex,NoOfCategoricalValuesRequired,NoOfNumericalValuesRequired);
	//			//			objAnalysisPage.AllEightTypesOfPlotCreation("All8TypesPlots", "All8TypesPlots", "1","3","3");
	//			onSuccessMeassage("8 Plots is successfully verified");
	//		}
	//		catch(Throwable ex)
	//		{
	//			objAnalysisPage.captureScreenshot("All8TypesPlotsVerificationFail");
	//			onFailureMeassage(ex.getMessage(),"All8TypesPlotsVerificationFail","All8TypesPlotsVerificationFail");
	//		}
	//	}	
	...
	//	@Test(priority = 8, description = "Verify a Numerical Value in Analysis")
