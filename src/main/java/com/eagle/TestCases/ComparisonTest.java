...
//		}
	...
	//	@Test(priority = 8, description = "Comparison - Expand and add items from Catalog")
	//	public void ComparisonExpandAddFromCatalog_Test() throws Throwable  {
	//		try {
	//			/* Set - Expand and add items from Catalog */
	//			objComparisonPage.ExpandAddFromCatalog("ExpAddFromCatalog", "Disease", "aber", "dengue");
	...
	//	}
	//
	//	@Test(priority = 9, description = "Comparison - Expand and add items from Set")
	//	public void ComparisonExpandAddFromSet_Test() throws Throwable  {
	//		try {
	//			/* Comparison - Expand and add items from Set */
	//			objComparisonPage.ExpandAddFromSet("SetAdd 1", "Disease", "aber", "ExpAddFromSet", "dol" ); 
	//			objComparisonPage.saveChanges();
	...
	//	}
	//
	//	@Test(priority = 10, description = "Comparison - Expand and add items from File")
	//	public void ComparisonExpandAddFromFile_Test() throws Throwable  {
	//		try {
	//			/* Comparison - Expand and add items from File */
	//			objComparisonPage.ExpandAddFromFile("ExpAddfromFile 1","Disease","kera","Disease", "C:\\Users\\MugunthRaman\\git\\EagleAutomation\\Resources\\Q4 - Upload file - 1 (2).xlsx", "Q4 - Upload file - 1 (2).xlsx");
	//			objComparisonPage.saveChanges();
	...
	//	}
	//
	//	@Test(priority = 11, description = "Comparison - Create with one additional relation Card")
	//	public void ComparisonCreateARelationCard_Test() throws Throwable  {
	//		try {
	//			/* Comparison - Create with one additional relation Card */
	//			objComparisonPage.createRelationCardFirst("ExpRela 1", "Disease", "kera", "Gene");
	//			onSuccessMeassage("Comparison Created and added with a relation Card Successfully");
	//		}
	//		catch(Exception ex)
	//		{
	//			objComparisonPage.captureScreenshot("ComparisonAddARelationFail");
	//			onFailureMeassage(ex.getMessage(),"ComparisonAddARelationFail","ComparisonAddARelationFail");
	//		}
	//		catch(AssertionError ex)
	//		{
	//			objComparisonPage.captureScreenshot("ComparisonAddARelationFail");
	...
	//	}
	//
	//	//	 	@Test(priority = 12, description = "Comparison - Create with 2 additional relation Card")
	//	//		public void ComparisonCreateTwoRelationCard_Test() throws Throwable  {
	//	//		try {
	//	//			/* Comparison - Create with 2 additional relation Cards */
	//	//			objComparisonPage.createRelationCardMulti("ExpRela 2", "Disease", "kera", "Gene","Chemical Compound","5");
	//	//			onSuccessMeassage("Comparison Created and added with 2 relation Cards Successfully");
	//	//		}
	//	//		catch(Exception ex)
	//	//		{
	...
	//	//	}
	//
	//		@Test(priority = 13, description = "Create And Delete An Comparison")
	...
	//		}
	//	
	//		@Test(priority = 14, description = "Create And Share An Comparison")
	...
	//		}
	//	
//	@Test(priority = 15, description = "Delete A Comparison")
...
//	}
//
//	@Test(priority = 16, description = "Sharing A Comparison")
...
//	}
	...
	//	//	@Test(priority = 17, description = "Remove items from Comparison Expand")
